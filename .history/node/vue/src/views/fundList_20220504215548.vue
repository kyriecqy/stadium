...
<!--
  ...
  <div>
    <div class="btn">
      <el-form label="按照时间筛选:" class="time_picker" slot-scope="">
        <el-time-picker
          is-range
          arrow-control
          range-separator="To"
          :start-placeholder="search_time.start_time"
          :end-placeholder="search_time.end_time"
        />
      </el-form>
...
export default ({
  ...
  mounted() {
    ...
    console.log(new Date('2022-5-3').toJSON());
  },
})
</script>
