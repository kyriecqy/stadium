<template>
  <div class="register">
    <div class="container">
      ...
      <div class="body">
        <el-form v-model="registerUser" :rules="rules" ref="registerForm" label-width="120px" class="demo-ruleForm">
          ...
          <el-form-item label="确认密码" prop="password2">
            <el-input type="password" v-model="registerUser.password2" placeholder="请再次输入密码"/>
          </el-form-item>
        </el-form>
      </div>
    </div>
